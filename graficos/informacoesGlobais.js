...
async function vizualizarInformacoesSinuca() {
    ...
    paragrafo.classList.add('sinuca-container__texto')
    ...
    const container = document.getElementById('sinuca-container')
    container.appendChild(paragrafo)
}

vizualizarInformacoesSinuca()
